...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'admin/networking/ports/create.html'
    success_url = 'horizon:admin:networking:detail'
    failure_url = 'horizon:admin:networking:detail'
...
class UpdateView(project_views.UpdateView):
    ...
    template_name = 'admin/networking/ports/update.html'
