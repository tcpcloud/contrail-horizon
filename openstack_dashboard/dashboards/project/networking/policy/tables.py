...
class DeletePolicy(tables.DeleteAction):
    data_type_singular = _("Network Policy")
    data_type_plural = _("Network Policies")
...
class CreatePolicy(tables.LinkAction):
    ...
    url = "horizon:project:networking:policy:create"
...
class EditPolicy(tables.LinkAction):
    ...
    url = "horizon:project:networking:policy:update"
...
class EditRules(tables.LinkAction):
    ...
    url = "horizon:project:networking:policy:detail"
    classes = ("btn-edit")

def get_associated_nets(policy):
    if hasattr(policy, 'nets_using') and len(policy['nets_using']):
        template_name = 'project/networking/_networks.html'
...
def get_rule_actions(rule):
    template_name = 'project/networking/policy/_rule_action_format.html'
...
def get_policy_rules(policy):
    template_name = 'project/networking/policy/_rule_format.html'
...
class CreateRule(tables.LinkAction):
    ...
    url = "horizon:project:networking:policy:add_rule"
    classes = ("ajax-modal", "btn-create")
...
class DeleteRule(tables.DeleteAction):
    ...
    def get_success_url(self, request):
        ...
        return reverse("horizon:project:networking:"
