...
class DeleteIpam(tables.DeleteAction):
    data_type_singular = _("Network IPAM")
    data_type_plural = _("Network IPAMs")
...
class CreateIpam(tables.LinkAction):
    ...
    url = "horizon:project:networking:ipam:create"
...
class EditIpam(tables.LinkAction):
    ...
    url = "horizon:project:networking:ipam:update"
...
def get_dns_details(ipam_obj):
    ...
    if not 'ipam_dns_method' in ipam:
        return 'None'
