...
from contrail_openstack_dashboard.openstack_dashboard.dashboards.project.networking import tests
from openstack_dashboard.test import helpers as test


INDEX_URL = reverse('horizon:admin:networking:index')
...
class NetworkTests(test.BaseAdminViewTests):
    ...
    def test_index(self):
        ...
        self.assertTemplateUsed(res, 'admin/networking/index.html')
    ...
    def test_network_detail(self):
        ...
        res = self.client.get(reverse('horizon:admin:networking:detail',
                                      args=[network_id]))
    ...
    def test_network_detail_network_exception(self):
        ...
        url = reverse('horizon:admin:networking:detail', args=[network_id])
    ...
    def test_network_create_get(self):
        ...
        url = reverse('horizon:admin:networking:create')
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'admin/networking/create.html')
    ...
    def test_network_update_get(self):
        ...
        url = reverse('horizon:admin:networking:update', args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'admin/networking/update.html')
...
class NetworkSubnetTests(test.BaseAdminViewTests):
    ...
    def test_subnet_detail(self):
        ...
        url = reverse('horizon:admin:networking:subnets:detail',
                      args=[subnet.id])
        res = self.client.get(url)
    ...
    def test_subnet_delete(self):
        ...
        url = reverse('horizon:admin:networking:detail',
                      args=[network_id])
        res = self.client.post(url, form_data)
...
class NetworkPortTests(test.BaseAdminViewTests):
    ...
    def test_port_detail(self):
        ...
        res = self.client.get(reverse('horizon:admin:networking:ports:detail',
                                      args=[port.id]))
    ...
    def test_port_create_get(self):
        ...
        url = reverse('horizon:admin:networking:addport',
                      args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'admin/networking/ports/create.html')
    ...
    def test_port_update_get(self):
        ...
        url = reverse('horizon:admin:networking:editport',
                      args=[port.network_id, port.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'admin/networking/ports/update.html')
