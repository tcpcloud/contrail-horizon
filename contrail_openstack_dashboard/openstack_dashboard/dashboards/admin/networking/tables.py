...
class DeleteNetwork(tables.DeleteAction):
    ...
    def delete(self, request, obj_id):
        try:
            ...
            LOG.info(msg)
            redirect = reverse('horizon:admin:networking:index')
...
class CreateNetwork(tables.LinkAction):
    ...
    url = "horizon:admin:networking:create"
...
class EditNetwork(tables.LinkAction):
    ...
    url = "horizon:admin:networking:update"
...
class NetworksTable(tables.DataTable):
    ...
    name = tables.Column("name", verbose_name=_("Network Name"),
                         link='horizon:admin:networking:detail')
    subnets = tables.Column(project_tables.get_subnets,
                            verbose_name=_("Subnets Associated"),)
    policies = tables.Column(project_tables.get_policies,
    ...
    class Meta:
        ...
        table_actions = (project_tables.NetFilterAction,
