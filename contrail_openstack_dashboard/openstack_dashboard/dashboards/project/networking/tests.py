...
from openstack_dashboard.dashboards.project.networking import workflows


INDEX_URL = reverse('horizon:project:networking:index')
...
class NetworkTests(test.TestCase):
    ...
    def test_index(self):
        ...
        self.assertTemplateUsed(res, 'project/networking/index.html')
    ...
    def test_network_detail(self):
        ...
        res = self.client.get(reverse('horizon:project:networking:detail',
                                      args=[network_id]))

        self.assertTemplateUsed(res, 'project/networking/detail.html')
    ...
    def test_network_detail_network_exception(self):
        ...
        url = reverse('horizon:project:networking:detail', args=[network_id])
    ...
    def test_network_create_get(self):
        ...
        url = reverse('horizon:project:networking:create')
        res = self.client.get(url)
    ...
    def test_network_update_get(self):
        ...
        url = reverse('horizon:project:networking:update', args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'project/networking/update.html')
    ...
    def test_delete_network_no_subnet(self):
        ...
        form_data = {'action': 'networking__delete__%s' % network.id}
...
class NetworkSubnetTests(test.TestCase):
    ...
    def test_subnet_detail(self):
        ...
        url = reverse('horizon:project:networking:subnets:detail',
                      args=[subnet.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'project/networking/subnets/detail.html')
    ...
    def test_subnet_create_get(self):
        ...
        url = reverse('horizon:project:networking:addsubnet',
                      args=[network.id])
        res = self.client.get(url)
    ...
    def test_subnet_create_post(self):
        ...
        self.assertNoFormErrors(res)
        redir_url = reverse('horizon:project:networking:detail',
                            args=[subnet.network_id])
        self.assertRedirectsNoFollow(res, redir_url)
    ...
    def test_subnet_update_post(self):
        ...
        form_data = form_data_subnet(subnet,
                                     allocation_pools=[])
        url = reverse('horizon:project:networking:editsubnet',
    ...
    def test_subnet_delete(self):
        ...
        url = reverse('horizon:project:networking:detail',
                      args=[network_id])
        res = self.client.post(url, form_data)
...
class NetworkPortTests(test.TestCase):
    ...
    def test_port_detail(self):
        ...
        res = self.client.get(reverse('horizon:project:networking:ports:detail',
                                      args=[port.id]))

        self.assertTemplateUsed(res, 'project/networking/ports/detail.html')
    ...
    def test_port_update_get(self):
        ...
        url = reverse('horizon:project:networking:editport',
                      args=[port.network_id, port.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'project/networking/ports/update.html')
